...
// Source: github.com/vlone310/bss/internal/db/sqlc (interfaces: Store)
...
func (m *MockStore) Connect(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Connect(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Connect", reflect.TypeOf((*MockStore)(nil).Connect), arg0, arg1)
}
